...
const FloatingWhatsApp = ({ phoneNumber, message = "Hello! I'm interested in a car battery." }) => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      {showTooltip && (
        <div className="bg-white text-gray-800 text-sm px-3 py-2 rounded-lg shadow-md border border-gray-100 whitespace-nowrap relative">

                          ...
                          <div>
                            <p className="font-semibold text-sm">
                              {order.product_detail?.name ||
                                order.combo_product_detail?.name ||
                                "Battery Order"}
                            </p>
                    ...
                    {payments.slice(0, 3).map((p) => (
                      ...
                      >
                        <div>
                          ...
                          <p className="text-xs text-gray-500">
                            {p.method} · {p.created_at?.split("T")[0]}
                          </p>
                        </div>
                        <div className="text-right">
                          ...
                          <p
                            className={`text-xs font-semibold ${paymentStatusColor(p.status)}`}
                          >
                            {p.status}
                          </p>
                        </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm">
                ...
                {orders.length === 0 ? (
                  ...
                  orders.map((order) => {
                    ...
                    const detail =
                      firstItem?.product_detail ||
                      firstItem?.combo_product_detail;
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start justify-between gap-2">
                              <div>
                                ...
                                {firstItem?.is_exchange && (
                                  <span className="inline-block mt-1 text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full">
                                    Exchange applied · -₹
                                    {firstItem.exchange_discount}
                                  </span>
                                )}
                      ...
                      <tbody>
                        {payments.map((p) => (
                          <tr key={p.id} className="border-b last:border-0">
                            ...
                            <td className="py-3">
                              <span
                                className={`font-semibold ${paymentStatusColor(p.status)}`}
                              >
                                {p.status || "PENDING"}
                              </span>
                            </td>
